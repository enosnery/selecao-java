...
public class Constants {
    ...
    public static String INVALID_FORMAT = "Arquivo em Formato Inválido.";
    public static String ERROR_LIST_EMPTY = "Não foi possível importar os dados do CSV.";
    ...
    public static String REQUEST_NO_CITY = "Cidade Inválida.";
    public static String REQUEST_NO_ID = "ID Inválido. Favor verificar e tentar novamente.";
    public static String REQUEST_NO_ITEM = "Este item não existe.";
}
